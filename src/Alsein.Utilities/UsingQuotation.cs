...
namespace Alsein.Utilities
{
    ...
    internal class UsingQuotation<TResult> : UsingQuotation, IUsingQuotation<TResult>
    {
    ...
    internal class TopUsingQuotation<TResult> : UsingQuotation<TResult>
    {
